...
<body>
    ...
    <main class="container mt-4">
        ...
        <div class="product-container my-4">
            <h2 class="text-center" style="color: #D9D9D9;">Produtos</h2>
            <div class="row">
                <div class="col-md-3">
                    <div class="card mb-3">
                        <img src="{{ asset('img/assassins_creed_rogue_imagem.png') }}" class="card-img-top" alt="Assassin's Creed Rogue">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #B94949;">Assassin's Creed Rogue</h5>
                            <p class="card-text" style="color: #555;">Descrição do produto 1.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card mb-3">
                        <img src="{{ asset('img/buckshot_roulette_imagem.png') }}" class="card-img-top" alt="Buckshot Roulette">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #B94949;">Buckshot Roulette</h5>
                            <p class="card-text" style="color: #555;">Descrição do produto 2.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card mb-3">
                        <img src="{{ asset('img/minecraft_imagem.png') }}" class="card-img-top" alt="Minecraft">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #B94949;">Minecraft</h5>
                            <p class="card-text" style="color: #555;">Descrição do produto 3.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card mb-3">
                        <img src="{{ asset('img/no_mans_sky_imagem.png') }}" class="card-img-top" alt="No Man's Sky">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #B94949;">No Man's Sky</h5>
                            <p class="card-text" style="color: #555;">Descrição do produto 4.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card mb-3">
                        <img src="{{ asset('img/product1.png') }}" class="card-img-top" alt="Produto 1">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #B94949;">Produto 1</h5>
                            <p class="card-text" style="color: #555;">Descrição do produto 1.</p>
                        </div>
                    </div>
                </div>
